...
import {
  ...
  updateReview,
  removeReview,
  getMostReviewedMoviesWithTopComment,
...
//가장 리뷰가 많은 영화 중 가장 많은 댓글 수가 많은 리뷰 가져오기 - /api/reviews/most-reviewed
router.get('/highlight', getMostReviewedMoviesWithTopComment);
//리뷰 생성 - /api/reviews
