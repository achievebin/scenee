...
const EventBoard = () => {
  ...
  if (!events.length) {
    return <h2 style={{ padding: "1rem", fontSize: "1.25rem" }}>🎁 이벤트를 불러오는 중.....</h2>;
  }
      ...
      <html>
        ...
        <body>
          ...
          <div class="meta">
            ...
            ${calcDaysLeft(event_date) != null ? `<strong>남은 일수:</strong> ${calcDaysLeft(event_date)}일` : ""}
          </div>
    ...
    <div style={styles.board}>
      ...
      <ul style={styles.list}>
        {events.map((ev) => {
          ...
          return (
            <li key={ev.id} style={styles.item} onClick={() => openEventWindow(ev)}>
              <div
                style={{
                  ...styles.thumbnail,
                  backgroundImage: ev.thumbnail_url ? `url(${ev.thumbnail_url})` : "none"
                }}
              />
