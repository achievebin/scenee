...
import { TMDB_IMAGE_BASE_URL, POSTER_SIZE, BACKDROP_SIZE } from '../../constants/tmdb';
...
export default function MovieBasicInfo() {
  ...
  return (
    <section className={styles.header} style={{backgroundImage: `url(${backdropUrl})`}}>
        <section className={styles.overlay}>
            ...
            <article>
                ...
                <p><strong>러닝타임:</strong> {movie.runtime}</p>
